...
background:“linear-gradient(145deg,#1e1b4b,#0d0f1a)”,
display:“flex”, alignItems:“center”, justifyContent:“center”,
boxShadow:`0 0 60px rgba(139,92,246,0.35), 0 8px 32px rgba(0,0,0,0.6)`,
...
```
  ...
  <div style={{ textAlign:"center" }}>
    ...
    <div style={{ fontSize:"13px", color:"rgba(167,139,250,0.5)", letterSpacing:"0.06em" }}>
